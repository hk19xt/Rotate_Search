...
/*This class is the implementation class to find the target value in the array.
...
public class Rotate_Search {
    ...
    public int calculation(int[] inputs, int target){
        ...
        //In order to find the minimum value, we should consider the three cases in total.
